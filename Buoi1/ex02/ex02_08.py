...
def chia_het_cho_5(so_nhi_phan):
    ...
    # Kiểm tra xem sô thập phân có chia hết cho 5 không
    if so_thap_phan % 5 == 0:
        return True
    else:
        return False
# Nhạp chuỗi số nhị phân từ người dùng
chuoi_so_nhi_phan = input("Nhập chuỗi số nghị phân ( phân tách bởi dấu phẩy);")
...
# In ra các số nhị phân hia hết cho 5
